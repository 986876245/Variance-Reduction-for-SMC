...
plot(1:noObservations,yvar_system,'LineWidth', 1.5, 'Color', 'r')
xlabel('Time'); 
ylabel('Variance');
title("Systematic resampling")
...
plot(1:noObservations,yvar_multino,'LineWidth', 1.5, 'Color', 'g')
xlabel('Time'); 
ylabel('Variance');
title("Multinomial resampling")
...
plot(1:noObservations,yvar_residual, 'LineWidth', 1.5, 'Color', 'b')
xlabel('Time'); 
ylabel('Variance');
title("Residual resampling")
...
plot(1:noObservations,yvar_stra, 'LineWidth', 1.5, 'Color', 'c')
xlabel('Time'); 
ylabel('Variance');
title("Stratified resampling")
...
plot(1:noObservations,yvar_determ, 'LineWidth', 1.5, 'Color', 'm')
xlabel('Time'); 
ylabel('Variance');
